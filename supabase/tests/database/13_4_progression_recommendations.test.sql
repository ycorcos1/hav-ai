...
select ok(
  pg_temp.statement_fails($statement$
    insert into public.progression_recommendations (
      ...
      '00000000-0000-4000-8000-00000000000a',
      '10000000-0000-4000-8000-000000000001', 'unknown', 'high',
...
select ok(
  pg_temp.statement_fails($statement$
    insert into public.progression_recommendations (
      ...
      '00000000-0000-4000-8000-00000000000a',
      '10000000-0000-4000-8000-000000000001', 'repeat_target', 'certain',
      '["WITHIN_TARGET_RANGE"]', 'active', 'progression-v1'
    )
  $statement$),
...
select ok(
  pg_temp.statement_fails($statement$
    insert into public.progression_recommendations (
      ...
      '00000000-0000-4000-8000-00000000000a',
      '10000000-0000-4000-8000-000000000001', 'repeat_target', 'high',
...
select ok(
  pg_temp.statement_fails($statement$
    insert into public.progression_recommendations (
      ...
      '00000000-0000-4000-8000-00000000000a',
      '10000000-0000-4000-8000-000000000001', 'repeat_target', -1,
...
select ok(
  pg_temp.statement_fails($statement$
    insert into public.progression_recommendations (
      ...
      '00000000-0000-4000-8000-00000000000a',
      '10000000-0000-4000-8000-000000000001', 'repeat_target', 0,
...
select ok(
  pg_temp.statement_fails($statement$
    insert into public.progression_recommendations (
      ...
      '00000000-0000-4000-8000-00000000000a',
      '10000000-0000-4000-8000-000000000001', 'increase_reps', 3,
...
select ok(
  pg_temp.statement_fails($statement$
    insert into public.progression_recommendations (
      ...
      '00000000-0000-4000-8000-00000000000b',
      '10000000-0000-4000-8000-000000000001', 'repeat_target', 'medium',
